...
class Ad
{
     ...
     * @Assert\Length(
     *      min = 100, 
     *      minMessage = "Votre description ne peut être inférieure à 100 caractères"
     * )
     */
    private $content;
    ...
    /**
     * Initilizes the slug before persist or before update
     * 
     * @ORM\PrePersist
     * @ORM\PreUpdate
     */
    ...
    /**
     * Get an author comment based on a specific Ad
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * Get the ratings average of the Ad
     *
     * @return float
     */
    ...
    /**
     * Return an array that contains all unavailable days for
     * specified Ad
     *
     * @return array DateTime object that represents the taken days
     */
    public function getNotAvailableDays() {
        $notAvailableDays = [];

        foreach($this->bookings as $booking) {
            // Calculate the days between the start date and end date
            $resultat = range(
